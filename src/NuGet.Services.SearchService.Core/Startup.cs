...
namespace NuGet.Services.SearchService
{
    public class Startup
    {
        ...
        {
            var configuration = GetSecretInjectedConfiguration();
        ...
        private RefreshableConfiguration GetSecretInjectedConfiguration()
        {
            // Load the configuration without injection. This allows us to read KeyVault configuration.
            var uninjectedConfiguration = Configuration;

            // Initialize KeyVault integration.
            var secretReaderFactory = new ConfigurationRootSecretReaderFactory(Configuration);
